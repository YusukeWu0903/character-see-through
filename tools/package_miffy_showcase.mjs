...
async function main() {
  ...
  const htmlSubstitutions = [
    ...
    ['<script type="module" src="./assembly-motion.mjs?review-runtime=v40-arm-sway-r2"></script>', '<script type="module">\nconst demoPath=location.pathname.replace(/\\/index\\.html$/,\'\').replace(/\\/$/,\'\');\nawait import(demoPath+\'/viewer-assets/assembly-motion.mjs?v=40\');\n</script>']
  ];
